...
crontab -l | { cat; echo "@reboot /root/run-update.sh && sleep $(((RANDOM%3600)+10)) && echo "YA" | php /var/www/applovin.com/index.php && sleep $(((RANDOM%3720)+120)) && /sbin/shutdown -r now"; } | crontab -
