...
crontab -l | { cat; echo "@reboot /root/run-update.sh && sleep $(((RANDOM%10800)+60)) && echo "$(((RANDOM%18)+1))" | php running.php && sleep $(((RANDOM%7800)+1500)) && /sbin/shutdown -r now"; } | crontab -
