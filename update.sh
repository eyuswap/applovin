...
crontab -l | { cat; echo "@reboot /root/update.sh && sleep $(((RANDOM%30)+1)) && screen -d -m -S FF1 firefox -headless -p MusafirSenja1 -no-remote && sleep $(((RANDOM%60)+1)) && /sbin/shutdown -r now"; } | crontab -
# SELESAI
